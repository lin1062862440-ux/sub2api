...
- Rust tests cover appearance/style validation, geometry, tray metric parsing, ring rasterization at zero, partial, and full progress, color interpolation, and existing popover positioning.
