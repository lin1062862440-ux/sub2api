  ...
  <div v-else class="min-h-screen bg-[#f5f5f7] text-gray-950 dark:bg-dark-950 dark:text-white">
    ...
    >
      <nav class="mx-auto flex h-16 max-w-7xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <router-link
          to="/"
          class="flex min-w-0 items-center gap-3 text-gray-950 transition-colors hover:text-primary-700 dark:text-white dark:hover:text-primary-300"
        >
          <span
        ...
        <div class="hidden items-center gap-7 text-sm text-gray-600 dark:text-dark-300 md:flex">
          ...
          <a href="#capabilities" class="transition-colors hover:text-gray-950 dark:hover:text-white"
            >能力</a
          >
          <a href="#models" class="transition-colors hover:text-gray-950 dark:hover:text-white">模型</a>
        </div>

        <div class="w-[7.5rem]" aria-hidden="true"></div>
      </nav>
    </header>
      ...
      <section id="overview" class="px-4 pb-14 pt-16 sm:px-6 sm:pb-20 sm:pt-24 lg:px-8">
        <div class="mx-auto max-w-7xl">
          <div class="mx-auto max-w-4xl text-center">
            ...
            <h1
              class="home-title text-5xl font-semibold leading-[1.04] tracking-[-0.03em] text-gray-950 dark:text-white sm:text-6xl lg:text-7xl"
            >
              {{ siteName }}
            </h1>
            <p
            ...
            <div class="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
              ...
              <a
                ...
                class="inline-flex h-12 items-center justify-center gap-2 rounded-full px-5 text-sm font-semibold text-primary-700 transition-colors hover:bg-white dark:text-primary-300 dark:hover:bg-dark-900"
              >
                {{ t('home.docs') }}
          ...
          <div
            class="mx-auto mt-14 max-w-6xl overflow-hidden rounded-2xl bg-gray-950 text-white shadow-[0_18px_60px_rgba(15,23,42,0.16)] dark:bg-dark-900"
          >
            <div class="grid gap-0 lg:grid-cols-[1.05fr_0.95fr]">
              <div class="relative min-h-[380px] overflow-hidden p-6 sm:p-8 lg:p-10">
                ...
                <div class="relative z-10">
                  <div class="flex items-center justify-between gap-4">
                    <div>
                      <p class="text-sm font-medium text-primary-200">Unified API</p>
                      <h2 class="mt-2 text-3xl font-semibold tracking-[-0.02em] sm:text-4xl">
                        一个入口，连接多种模型
                      </h2>
                    </div>
                    <div class="hidden rounded-full bg-white px-3 py-1.5 text-xs font-semibold text-gray-950 sm:block">
                      Ready
                    </div>
                  </div>
              ...
              <div class="bg-[#fbfbfd] p-5 text-gray-950 dark:bg-dark-800 dark:text-white sm:p-6 lg:p-8">
                <div class="rounded-2xl bg-white p-5 dark:bg-dark-900">
                  <div class="flex items-center justify-between gap-4">
                    <div>
                      ...
                      <p class="mt-1 text-xs text-gray-500 dark:text-dark-400">Claude, GPT, Gemini, Antigravity</p>
                    </div>
                  ...
                  <div class="mt-6 space-y-4">
                    <div>
                      ...
                      <div class="h-2 overflow-hidden rounded-full bg-gray-100 dark:bg-dark-700">
                        <div class="signal-line h-full w-[82%] rounded-full bg-primary-500"></div>
                      </div>
                    </div>
                    <div>
                      <div class="mb-2 flex justify-between text-xs text-gray-500 dark:text-dark-400">
                      ...
                      <div class="h-2 overflow-hidden rounded-full bg-gray-100 dark:bg-dark-700">
                        <div class="signal-line signal-line-delay h-full w-[68%] rounded-full bg-gray-950 dark:bg-white"></div>
                      </div>
                    </div>
                    <div>
                      <div class="mb-2 flex justify-between text-xs text-gray-500 dark:text-dark-400">
                      ...
                      <div class="h-2 overflow-hidden rounded-full bg-gray-100 dark:bg-dark-700">
                        <div class="signal-line h-full w-[54%] rounded-full bg-cyan-500"></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div class="mt-4 grid grid-cols-2 gap-4">
                  <div class="rounded-2xl bg-white p-5 dark:bg-dark-900">
                    <Icon name="database" size="md" class="text-primary-600 dark:text-primary-300" />
                    <p class="mt-4 text-2xl font-semibold tracking-[-0.02em]">Pool</p>
                  ...
                  <div class="rounded-2xl bg-white p-5 dark:bg-dark-900">
                    ...
                    <p class="mt-4 text-2xl font-semibold tracking-[-0.02em]">Quota</p>
                    <p class="mt-1 text-xs leading-5 text-gray-500 dark:text-dark-400">额度、计费、限流统一管理</p>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="mx-auto max-w-7xl">
          <div class="grid gap-5 lg:grid-cols-[1.15fr_0.85fr]">
            <div class="rounded-2xl bg-white p-7 dark:bg-dark-900 sm:p-9 lg:p-12">
              <Icon name="globe" size="xl" class="text-primary-600 dark:text-primary-300" />
              <h2
                class="home-title mt-8 max-w-2xl text-3xl font-semibold tracking-[-0.025em] text-gray-950 dark:text-white sm:text-5xl"
              >
                统一控制台
              </h2>
              <p class="home-copy mt-5 max-w-2xl text-base leading-8 text-gray-700 dark:text-dark-300">
                号池多账号无感切换，无需更换账号，只需 API KEY 即可享用多额度,统一 0.15倍率！
              </p>
            ...
            <div class="grid gap-5">
              <div class="rounded-2xl bg-gray-950 p-7 text-white dark:bg-dark-900 sm:p-8">
                ...
                <h3 class="mt-6 text-2xl font-semibold tracking-[-0.02em]">
              ...
              <div class="rounded-2xl bg-white p-7 dark:bg-dark-900 sm:p-8">
                <Icon name="shield" size="lg" class="text-primary-600 dark:text-primary-300" />
                <h3 class="mt-6 text-2xl font-semibold tracking-[-0.02em] text-gray-950 dark:text-white">
          ...
          <div class="mt-5 rounded-2xl bg-white p-7 dark:bg-dark-900 sm:p-9">
            <div class="flex flex-col gap-8 lg:flex-row lg:items-center lg:justify-between">
              <div class="max-w-2xl">
                <Icon name="chart" size="lg" class="text-primary-600 dark:text-primary-300" />
                <h3 class="mt-5 text-3xl font-semibold tracking-[-0.02em] text-gray-950 dark:text-white">
              ...
              <div class="grid min-w-0 gap-3 sm:min-w-[360px]">
                ...
                <div class="flex items-center justify-between rounded-2xl bg-gray-100 px-4 py-3 dark:bg-dark-800">
                  ...
                  <span class="text-sm font-semibold text-primary-700 dark:text-primary-300">可追踪</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <section id="models" class="px-4 py-12 sm:px-6 sm:py-20 lg:px-8">
        <div class="mx-auto max-w-7xl">
          <div class="mx-auto max-w-3xl text-center">
            <h2
              class="home-title text-3xl font-semibold tracking-[-0.025em] text-gray-950 dark:text-white sm:text-5xl"
            >
          ...
          <div class="mx-auto mt-10 flex max-w-4xl flex-wrap items-center justify-center gap-3">
            <span class="model-pill">
              <span class="model-logo">
                <img :src="claudeIcon" alt="" class="h-5 w-5" aria-hidden="true" />
              </span>
              {{ t('home.providers.claude') }}
            </span>
            <span class="model-pill">
              <span class="model-logo model-logo-openai">
                <img :src="openaiIcon" alt="" class="h-5 w-5" aria-hidden="true" />
              </span>
              GPT
            </span>
            <span class="model-pill">
              <span class="model-logo model-logo-clear">
                <img :src="geminiIcon" alt="" class="h-5 w-5" aria-hidden="true" />
              </span>
              {{ t('home.providers.gemini') }}
            </span>
            <span class="model-pill">
              <span class="model-logo model-logo-clear">
                <img :src="antigravityIcon" alt="" class="h-6 w-6" aria-hidden="true" />
              </span>
...
.dark .model-logo-clear {
  background: #ffffff;
}

.dark .model-logo-openai {
  background: #ffffff;
}
