...
.markdown-body a {
  @apply font-medium text-primary-700 underline decoration-primary-600/30 decoration-2 underline-offset-2 transition-colors hover:decoration-primary-700 dark:text-primary-300 dark:decoration-primary-300/30 dark:hover:decoration-primary-300;
}
...
.markdown-body blockquote {
  @apply my-5 rounded-xl border border-primary-200 bg-primary-50/50 px-4 py-3 text-gray-700 dark:border-primary-400/20 dark:bg-primary-500/10 dark:text-gray-300;
}
