    ...
    <div class="flex h-14 items-center justify-between rounded-2xl border border-white/70 bg-white/82 px-3 shadow-[0_10px_30px_rgb(15_23_42/0.08)] backdrop-blur-xl dark:border-white/10 dark:bg-dark-950/72 dark:shadow-none md:px-4">
      ...
      <div class="flex items-center gap-2 sm:gap-3">
        ...
        <router-link
          ...
          class="hidden h-10 items-center gap-1.5 rounded-full px-3 text-sm font-medium text-gray-600 transition-colors hover:bg-white hover:text-gray-950 dark:text-dark-300 dark:hover:bg-dark-900 dark:hover:text-white sm:flex"
        >
        ...
        <div
          v-if="user"
          class="group relative hidden h-10 items-center gap-2 rounded-full bg-white px-3 text-gray-950 ring-1 ring-gray-950/5 dark:bg-dark-900 dark:text-white dark:ring-white/10 sm:flex"
        >
