...
func scanUsageLog(scanner interface{ Scan(...any) error }) (*service.UsageLog, error) {
	var (
		...
		businessUserGroupID       sql.NullInt64
		inputTokens               int
		outputTokens              int
	...
	if businessUserGroupID.Valid {
		value := businessUserGroupID.Int64
		log.BusinessUserGroupID = &value
	}
	if durationMs.Valid {
