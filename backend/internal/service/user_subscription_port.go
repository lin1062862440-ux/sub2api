...
type UserSubscriptionRepository interface {
	...
	List(ctx context.Context, params pagination.PaginationParams, userID, groupID *int64, status, platform, search, sortBy, sortOrder string) ([]UserSubscription, *pagination.PaginationResult, error)
