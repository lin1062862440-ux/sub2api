...
func TestRegisterUserGroupRoutesMountsExpectedSurface(t *testing.T) {
	...
	expected := []string{
		...
		http.MethodPut + " /api/v1/user-groups/:id/team-subscription-groups",
		http.MethodGet + " /api/v1/user-groups/:id/subscriptions",
		http.MethodGet + " /api/v1/user-groups/:id/usage",
		http.MethodGet + " /api/v1/user-groups/:id/quota",
		http.MethodPut + " /api/v1/user-groups/:id/quota-policy",
		http.MethodPut + " /api/v1/user-groups/:id/quota-managers",
		http.MethodPut + " /api/v1/user-groups/:id/member-quotas",
		http.MethodPost + " /api/v1/user-groups/:id/quota-reset",
