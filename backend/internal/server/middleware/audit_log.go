...
var auditSensitiveReads = map[string]string{
	...
	"GET /api/v1/user-groups/:id/usage/:usageLogID/prompts": "user_group.prompt.view",
}
...
var auditActionOverrides = map[string]string{
	...
	"PUT /api/v1/user-groups/:id/prompt-capture":              "user_group.prompt_capture.update",
	"PUT /api/v1/user-groups/:id/prompt-viewers":              "user_group.prompt_viewers.update",
}
