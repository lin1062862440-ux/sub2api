...
const weeklyCumulativeUsed = computed(() => quota.value?.policy.weekly_cumulative_usage_usd ?? quota.value?.policy.weekly_usage_usd ?? 0)
...
.ug-date-controls{justify-content:flex-end;margin-top:13px}.ug-advanced-filters{grid-template-columns:repeat(2,minmax(0,1fr))}.ug-team-quota{display:grid;grid-template-columns:repeat(5,1fr);margin-top:12px;overflow:hidden;border:1px solid #cfe0d8;border-radius:8px;background:#f6fbf8}.ug-team-quota>div{display:grid;min-height:62px;align-content:center;gap:4px;padding:0 14px;border-right:1px solid #dbe8e0}.ug-team-quota>div:last-child{border:0}.ug-team-quota span{color:#658074;font-size:10px}.ug-team-quota strong{font-family:var(--font-data);font-size:14px;color:#275f49}@container app-content (max-width:700px){.ug-team-quota{grid-template-columns:repeat(2,1fr)}.ug-team-quota>div:nth-child(2n){border-right:0}.ug-team-quota>div:last-child{border-right:0}}
